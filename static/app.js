...
const TRANSLATIONS = {
  en: {
    ...
    step3_label:          'Mode',
    dry_run_title:        '👁 Preview only (recommended first)',
    dry_run_desc:         'Shows who would be blocked — no action taken. Safe to run first to verify.',
    block_title:          '🚫 Block everyone',
    block_desc:           'Blocks all members of the list. ~13 minutes for 500 users.',
    start_btn:            '🚀 Start',
  ...
  fa: {
    ...
    step3_label:          'حالت',
    dry_run_title:        '👁 فقط پیش\u200cنمایش (اول پیشنهاد می\u200cشود)',
    dry_run_desc:         'نشان می\u200cدهد چه کسانی مسدود می\u200cشوند — بدون هیچ اقدامی. برای تأیید ابتدا اجرا کنید.',
    block_title:          '🚫 مسدود کردن همه',
    block_desc:           'تمام اعضای لیست را مسدود می\u200cکند. حدود ۱۳ دقیقه برای ۵۰۰ کاربر.',
    start_btn:            '🚀 شروع',
